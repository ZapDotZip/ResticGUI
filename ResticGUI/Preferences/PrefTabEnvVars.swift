...
class PrefTabEnvVars: NSViewController {
	...
	override func viewDidLoad() {
		envTable.table.load(UserDefaults.standard.dictionary(forKey: DefaultsKeys.globalEnvTable) as! [String: String]?)
		...
		NotificationCenter.default.addObserver(forName: Notification.Name.EnvTableDidChange, object: envTable.table, queue: nil) { notif in
			UserDefaults.standard.set(self.envTable.table.save(), forKey: DefaultsKeys.globalEnvTable)
		}
	}
