...
## Current Status
- [x] Creating and saving profiles, repository list
- [x] Adding paths to back up from file picker, text file, or clipboard
- [x] Text/file-defined exclusions
- [x] Start backup and see progress
- [x] Add tags, Custom compression, read concurrency, and pack size
- [x] View, restore from, and mount snapshots
...
- [x] QoS (efficiency core) preferences, including low power mode and on-battery support, storage QoS support
- [x] Store repository passwords in the keychain
- [x] Delete snapshots
- [x] Open log menu item
- [x] Refresh snapshots list after backup/delete backup completes
